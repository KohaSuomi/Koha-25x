package C4::ClassSortRoutine::KohaSuomi;
...
C4::ClassSortRoutine::KohaSuomi - KohaSuomi call number sorting key routine

=head1 SYNOPSIS

use C4::ClassSortRoutine qw( GetClassSortKey );

my $cn_sort = GetClassSortKey('KohaSuomi', $cn_class, $cn_item);

=head1 FUNCTIONS

=head2 get_class_sort_key

  my $cn_sort = C4::ClassSortRoutine::KohaSuomi::KohaSuomi($cn_class, $cn_item);
