...
module.exports = [
    {
        ...
        entry: {
            ...
            "admin/hold_pickup_shelves":
                "./koha-tmpl/intranet-tmpl/prog/js/vue/modules/admin/hold_pickup_shelves.ts",
            hold_pickup_shelves:
                "./koha-tmpl/intranet-tmpl/prog/js/vue/modules/hold_pickup_shelves.ts",
            acquisitions:
